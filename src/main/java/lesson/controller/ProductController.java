...
import lesson.service.ProductServiceImpl;
...
public class ProductController {
    ...
    // http://localhost:8080/web/products - GET
    ...
    // http://localhost:8080/web/products/1 - GET
    ...
    // http://localhost:8080/web/products/1/price - GET
    ...
    // http://localhost:8080/web/products/new - GET
    @GetMapping("/new")
    ...
    // http://localhost:8080/web/products/new - POST
...
//    }
    ...
    // http://localhost:8080/web/products/any
...
//    }
    ...
    // http://localhost:8080/web/filter {title:"asd"}
    @PostMapping("/filter")
    @ResponseBody
